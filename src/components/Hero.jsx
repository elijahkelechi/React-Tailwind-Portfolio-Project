    ...
    >
      ...
      >
        <h1 className="text-white sm:tracking-wide md:tracking-widest sm:text-5xl text-4xl sm:font-bold font-semibold ">
          <span>Bringing</span>
          <span className="md:block block  "> Your</span>
          <span className="md:block block"> Dream </span>
          <span className="sm:block">Website</span>
          <span className="md:block sm:block"> to Reality</span>
        </h1>
